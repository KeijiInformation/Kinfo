...
// ポップアップボタントリガーここから
    ...
    for (let viewMoreBtn of viewMoreBtnList) {
        viewMoreBtn.addEventListener("click", function() {
            ...
            document.addEventListener("touchmove", fixBackground, {passive: false});
            document.addEventListener("mousewheel", fixBackground, {passive: false});
        }, false);
    }
// ポップアップボタントリガーここから
...
// ポップアップクローズここから
    ...
    popupCloseBtn.addEventListener("click", function() {
        popupClose();
        document.removeEventListener("touchmove", fixBackground, {passive: false});
        document.removeEventListener("mousewheel", fixBackground, {passive: false});
    }, false);
    bgCoverBox.addEventListener("click", function() {
        popupClose();
        document.removeEventListener("touchmove", fixBackground, {passive: false});
        document.removeEventListener("mousewheel", fixBackground, {passive: false});
    }, false);
