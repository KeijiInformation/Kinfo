            ...
            datasets: [
                {
                    ...
                    borderWidth: 1,
                    pointBackgroundColor: ["rgba(59,83,255,0.4)", "rgba(255,59,59,0.4)", "rgba(240,255,59,0.4)", "rgba(191,59,255,0.4)"],
                },
            ]
        },
...
// 言語ボタンここから
    ...
    const detailFooterDesignList = document.querySelectorAll('.detail-footer-design');
    ...
    function langBtnClick(target) {
        ...
        if (target.classList.contains('active')) {
            ...
            // 説明枠フッターのアニメーションここから
            detailFooterDesign = document.querySelectorAll('.language-detail-content' + '.' + activeClassName + ' .detail-footer-design');
        ...
        // none -> active (targetの切り替えと他要素のremoveが必要)
            ...
            for (langBtn of langBtnList) {
                if (langBtn.classList.contains('active')) {
                    ...
                    // 説明枠フッターのアニメーションここから
                    detailFooterDesignTargets = document.querySelectorAll('.language-detail-content' + '.' + activeClassName + ' .detail-footer-design');
